                    ...
                    <li key={todo.id}>
                        ...
                        {todo.type === 'solid' && (
                            <>
                                <span>SOLID</span>
                                <button onClick={() => {
                                    axios.patch(`http://localhost:3000/todos/${todo.id}`, {type: 'kiss'})
                                        .then(() => {
                                            axios.get('http://localhost:3000/todos')
                                                .then(({data}) => setTodos(data));
                                        });
                                    ...
                                    <span>Set type to KISS</span></button>
                            </>
                        )}
                        ...
                        {todo.type === 'kiss' && (
                            <>
                                <span>KISS</span>
                                <button onClick={() => {
                                    axios.patch(`http://localhost:3000/todos/${todo.id}`, {type: 'solid'})
                                        .then(() => {
                                            axios.get('http://localhost:3000/todos')
                                                .then(({data}) => setTodos(data));
                                        });
